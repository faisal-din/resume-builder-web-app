...
const ProfessionalSummaryForm = ({ data, onChange, setResumeData }) => {
  ...
  const generateAiSummary = async () => {
    try {
      ...
      const prompt = `Generate a professional summary "${data}".`;
...
disabled:opacity-50'
      ...
      <div className='mt-6'>
        <textarea
          rows={7}
          className='w-full p-3 px-4 mt-2 border border-gray-300 text-sm rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors resize-none'
