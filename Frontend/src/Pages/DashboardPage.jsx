...
bg-clip-text text-transparent sm:hidden'
        ...
        <div className='flex gap-4 '>
          <button
            ...
            className='w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-1g transition-all duration-300 cursor-pointer'
          >
            <PlusIcon
...
duration-300'
        ...
        <hr className='border-slate-300 my-3 sm:w-[305px]' />

        <div className='grid grid-cols-2 sm:flex flex-wrap gap-4 mt-4'>
