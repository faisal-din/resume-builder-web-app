...
const ResumeBuilderPage = () => {
  ...
  const loadExistingResume = async () => {
    try {
      ...
      console.log('Error loading existing resume: ', error.message);
    }
  };
  ...
  const sections = [
    { id: 'personal', name: 'Professional Info', icon: User },
  ...
  const changeResumeVisibility = async () => {
    try {
      ...
      console.log('Error changing resume visibility: ', error.message);
      toast.error(
        error.response?.data?.message || 'Failed to change resume visibility.'
      );
    }
  };
